package danielbernal.app.producer;
...
import danielbernal.app.producer.callback.BasicCallback;
import danielbernal.app.config.KafkaConfiguration;
import danielbernal.app.config.TwitterConfiguration;
import danielbernal.app.model.Tweet;
    ...
    public void run() {
        ...
        try (Producer<Long, String> producer = getProducer()) {
            while (true) {
                ...
                System.out.printf("Fetched tweet message %s\n", tweet.getText());
